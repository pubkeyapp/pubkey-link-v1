import { WebAuthLoginFeature, WebAuthRegisterFeature } from '@pubkey-link/web/auth/feature'
import { WebDashboardRoutes } from '@pubkey-link/web/dashboard/feature'
import { WebHomeRoutes } from '@pubkey-link/web/home/feature'
import { WebProfileRoutes } from '@pubkey-link/web/profile/feature'
import { WebSettingsRoutes } from '@pubkey-link/web/settings/feature'
import { UiNotFound } from '@pubkey-link/web/ui/core'
